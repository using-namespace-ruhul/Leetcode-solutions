<h2>867. Transpose Matrix</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a 2D integer array <code style="user-select: auto;">matrix</code>, return <em style="user-select: auto;">the <strong style="user-select: auto;">transpose</strong> of</em> <code style="user-select: auto;">matrix</code>.</p>
