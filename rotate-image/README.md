...
<img alt="" src="https://assets.leetcode.com/uploads/2020/08/28/mat1.jpg" style="width: 642px; height: 242px; user-select: auto;">
...
<img alt="" src="https://assets.leetcode.com/uploads/2020/08/28/mat2.jpg" style="width: 800px; height: 321px; user-select: auto;">
...
<pre style="user-select: auto;"><strong style="user-select: auto;">Input:</strong> matrix = [[1,2],[3,4]]
<strong style="user-select: auto;">Output:</strong> [[3,1],[4,2]]
</pre>
...
<ul style="user-select: auto;">
	<li style="user-select: auto;"><code style="user-select: auto;">matrix.length == n</code></li>
	<li style="user-select: auto;"><code style="user-select: auto;">matrix[i].length == n</code></li>
